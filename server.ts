...
io.on('connection', (socket) => {
  ...
  socket.on('update_state', (data: { segments: any[], score: number, currentAngle: number, isBoosting: boolean, state: string, color?: string, eatenColors?: Record<string, number> }) => {
    ...
    if (player && player.state === 'alive') {
      ...
      if (data.eatenColors) player.eatenColors = data.eatenColors;
